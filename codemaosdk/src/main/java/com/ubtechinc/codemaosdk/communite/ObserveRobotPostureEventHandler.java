...
public class ObserveRobotPostureEventHandler implements IMsgHandler {
    ...
    public void handleMsg(short requestCmdId, final short responseCmdId, final MiniMessage request, final String peer) {
        ...
        NotificationCenter.defaultCenter().publish(new RobotPostureEvent(cmObserveHeadRacketResponse.getStatus()));
