...
public class CustomCircleProgressBar extends View {
    ...
    public CustomCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        outsideColor = a.getColor(R.styleable.CustomCircleProgressBar_outside_color, ContextCompat.getColor(getContext(), R.color.alexa_button_normal_blue));
        outsideRadius = a.getDimension(R.styleable.CustomCircleProgressBar_outside_radius, dp2px( 60.0f));
        insideColor = a.getColor(R.styleable.CustomCircleProgressBar_inside_color, ContextCompat.getColor(getContext(), R.color.alexa_button_normal_blue));
        progressTextColor = a.getColor(R.styleable.CustomCircleProgressBar_progress_text_color, ContextCompat.getColor(getContext(), R.color.alexa_button_normal_blue));
    ...
    public void setAnimationListener(OnAnimationListener mOnAnimationListener){
    ...
    private void startAnim(float startProgress) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                Log.i("0524", "onAnimationUpdate: " + progress);
                postInvalidate();
            }
        });
