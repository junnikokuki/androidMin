...
public class ActionSheetDialog {
    ...
    public ActionSheetDialog builder() {
        ...
        space           =  view.findViewById(R.id.view_space);
    ...
    public ActionSheetDialog setSpaceVisible(boolean spaceVisible){
        if (spaceVisible){
    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            view.setBackgroundColor(context.getResources().getColor(R.color.color_contacts_divider_line));
