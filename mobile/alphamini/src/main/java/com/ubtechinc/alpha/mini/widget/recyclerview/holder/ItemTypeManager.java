...
import com.ubtechinc.alpha.mini.widget.recyclerview.item.ItemManager;
...
public class ItemTypeManager {
     ...
     * @see com.ubtechinc.alpha.mini.widget.recyclerview.BaseItemAdapter#register(Class, ViewHolderManager)
     */
     ...
     * @see com.ubtechinc.alpha.mini.widget.recyclerview.BaseItemAdapter#register(Class, ViewHolderManagerGroup)
     */
