...
public class RobotInfo implements Serializable {
    ...
    private List<RobotPermission> robotPermissionList;
    ...
    public List<RobotPermission> getRobotPermissionList() {
        return robotPermissionList;
    }

    public void setRobotPermissionList(List<RobotPermission> robotPermissionList) {
    ...
    public boolean hasPermission(String permissionCode) {
        ...
        if (!CollectionUtils.isEmpty(getRobotPermissionList())) {
            for (RobotPermission robotPermission : robotPermissionList) {
