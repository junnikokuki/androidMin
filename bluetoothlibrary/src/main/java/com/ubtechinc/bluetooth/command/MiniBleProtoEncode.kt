...
class MiniBleProtoEncode : ICommandEncode {
    ...
    private fun parseMessage(dataPairs: Array<MiniMessage>) : Boolean {
        LogUtils.i( "receive dataPairsSize =  " + dataPairs.size)
        for (msgRequest in dataPairs) {
            ...
            LogUtils.d("handleProtoBuffMsg--cmdId = " + miniMessage.commandId + ", requestId = " + miniMessage.sendSerial + ", responseId = " + miniMessage.responseSerial)
